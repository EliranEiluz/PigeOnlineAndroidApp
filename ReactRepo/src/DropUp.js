...
function DropUp({newPictureMessage, newVideoMessage, startRecord, newRecordMessage, resetRecord}) {


    function handleCloseRecordModal() {
        document.getElementById('recordModal').addEventListener('hidden.bs.modal', resetRecord, {once:true})
      }
    ...
    return(
        ...
        <div className='col-xl-1 col-sm-1 col-xs-1 col' id='dropUpCol'>
            <div className="btn-group dropup" id='dropUpMenu'>
                ...
                <button type="button" id="dropdownMenu2" data-bs-toggle="dropdown" onClick={handleCloseRecordModal}>
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={resetRecord}></button>
                    </div>

                    <div className="modal-body">
                        <p>
                            <button id="btnStart">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-record-circle" viewBox="0 0 16 16">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <button id="btnStop">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-stop-circle" viewBox="0 0 16 16">
                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                    ...
                    <div className="modal-footer">
                        <button type="button" id="addBtn" className="btn btn-primary" onClick={newRecordMessage}>send</button>
                    </div>
                </div>
            </div>
        </div>
